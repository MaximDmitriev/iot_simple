module.exports = {
  ...
  extends: ['plugin:prettier/recommended', 'plugin:import/typescript', 'plugin:compat/recommended'],
  plugins: ['@typescript-eslint', 'prettier', 'import', 'compat', 'unicorn', 'sonarjs'],
  ...
  ignorePatterns: ['*.d.ts'],
  settings: {
    polyfills: ['fetch', 'Map', 'Set', 'Promise', 'Symbol', 'String', 'Array', 'Math', 'Object', 'URL', 'URLSearchParams'],
  },
  rules: {
    ...
    // Допускается указание директивы `ts-expect-error` с описанием минимум 10символов,
    // например, ссылку на задачу по исправлению.
